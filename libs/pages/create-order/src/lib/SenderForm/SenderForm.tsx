...
export const SenderForm: React.FC<SenderFormProps> = ({
  ...
  <StyledSenderForm>
    <form className="p-grid" autoComplete="off" noValidate onSubmit={onSubmit}>
      ...
      <div className="p-col-12 p-md-6 p-md-offset-3">
        ...
        {getIn(touched, 'senderEmail') && getIn(errors, 'senderEmail') && (
          <Message
            id="senderEmail-error"
            severity="error"
            text={getIn(errors, 'senderEmail')}
          ></Message>
        )}
      </div>
      <div className="p-col-12 p-md-6 p-md-offset-3">
        ...
        {getIn(touched, 'senderPhone') && getIn(errors, 'senderPhone') && (
          <Message
            id="senderPhone-error"
            severity="error"
            text={getIn(errors, 'senderPhone')}
          ></Message>
        )}
      </div>
